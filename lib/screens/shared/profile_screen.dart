...
class ProfileScreen extends ConsumerWidget {
    ...
    return Scaffold(
      ...
      body: profileAsyncValue.when(
        ...
        error: (error, stackTrace) =>
            _buildErrorState(context, ref, error), // Helper error state
        data: (userProfile) {
          if (userProfile == null) {
          ...
          return RefreshIndicator(
            onRefresh: () async =>
                ref.invalidate(currentUserProfileProvider), // Pull-to-refresh
            child: ListView(
              // Ganti CustomScrollView jadi ListView
  ...
  Widget _buildUserInfoSection(UserProfile userProfile) {
    final joinDateFormatted = DateFormat(
      'MMMM yyyy',
      'id_ID',
    ).format(userProfile.joinDate);
    final jobTitle = UserRole.getRoleDisplayName(userProfile.role);
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: iconColor.withAlpha(
                20,
              ), // Background icon lebih transparan
