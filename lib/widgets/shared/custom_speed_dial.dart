...
class SpeedDialColors {
  /// Primary Mint Green - untuk action utama
  static const Color blue = Color(0xFF5FD8A5);

  /// Success Green - untuk layanan
  static const Color green = Color(0xFF4DD0A1);

  /// Warning Orange - untuk pending/warning
  static const Color orange = Color(0xFFFFB84D);

  /// Purple Accent - untuk filter/view
  static const Color purple = Color(0xFFAB7EED);

  /// Error Red - untuk urgent/delete
  static const Color red = Color(0xFFFF7B7B);

  /// Secondary Blue - untuk completed/success
  static const Color teal = Color(0xFF5FC8E8);

  /// Primary Mint - untuk admin actions
  static const Color indigo = Color(0xFF5FD8A5);

  /// Warning - untuk analytics/reports
