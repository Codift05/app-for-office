    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(icon: Icons.assignment, label: 'Tugas', index: 1),
          // Center space for FAB
          const SizedBox(width: 60),
          _buildNavItem(icon: Icons.inbox, label: 'Laporan', index: 2),
          _buildNavItem(icon: Icons.inventory_2, label: 'Inventaris', index: 3),
        ],
      ),
    );
  }
